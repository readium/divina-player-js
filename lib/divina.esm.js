import { Container as Container$2, Graphics, CanvasRenderer, utils, TextStyle, Text, TextMetrics, Ticker, Texture as Texture$2, Sprite, AnimatedSprite, Rectangle, Loader as Loader$2, LoaderResource, BaseTexture as BaseTexture$1 } from 'pixi.js';
...
class Renderer$1 {
	...
	constructor(rootElement, backgroundColor = null, player) {
		...
		}
		{
			...
			this._renderer = new CanvasRenderer(options);
