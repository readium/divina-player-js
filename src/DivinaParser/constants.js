...
// Loading parameters
export const DEFAULT_ALLOWS_PARALLEL = false
...
// User controls
export const DEFAULT_ALLOWS_ZOOM = true
export const DEFAULT_ALLOWS_SWIPE = true
export const DEFAULT_ALLOWS_WHEEL_SCROLL = true
// To allow discontinuous gestures to trigger pagination jumps (when overflow === "scrolled")
export const DEFAULT_ALLOWS_PAGINATED_SCROLL = true
// To make pagination sticky (only when overflow === "paginated")
export const DEFAULT_IS_PAGINATION_STICKY = true
// To compute automatically-computed snap points from the page start (vs. from the current position)
export const DEFAULT_IS_PAGINATION_GRID_BASED = true
